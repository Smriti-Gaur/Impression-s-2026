...
const eventsData = [
  ...
  { id: 2, name: "IEEE", event1: "Carnival Chroniacles 2.0", event2: "The Great College Heist 2.0", image: "src/Images/hubs_logo/IEEE.png" },
  { id: 3, name: "Crescendo", event1: "Battle of Bands", event2: "Solo Singing Competition" , image: "src/Images/hubs_logo/crescendo.png"},
  { id: 4, name: "Jhankaar", event1: "Group Dance Competition", event2: "Solo (On The Spot)", image: "src/Images/hubs_logo/Jhankaar.png" },
  { id: 5, name: "The Thespian Circle", event1: "Group Act Competition", event2: "Talent Con" , image: "src/Images/hubs_logo/Thespian.png"},
  { id: 6, name: "Finanza", event1: "Island Escape", image: "src/Images/hubs_logo/FINANZA.jpg" },
  { id: 7, name: "Radiance", event1: "Mr. & Miss Impressions" , image: "src/Images/hubs_logo/Radiace.png"},
  { id: 8, name: "RIBOSE", event1: "The Island Helix", event2: "Tropical Trail", image: "src/Images/hubs_logo/RIBOSE.png" },
  { id: 9, name: "Kalakriti", event1: "Design by Heart", image: "src/Images/hubs_logo/Kalakriti.png" },
  { id: 10, name: "JPEG", event1: "Wall Of Frames" , image: "src/Images/hubs_logo/JPEG.png"},
  { id: 11, name: "SILICA", event1: "Pitch Up", event2: "MindStorm" , image: "src/Images/hubs_logo/Silica.png"},
  { id: 12, name: "GIWM", event1: "QuestX" , image: "src/Images/hubs_logo/GIWM.png"},
  { id: 13, name: "DICE", event1: "Reverse Reality", event2: "Tropicrypt" , image: "src/Images/hubs_logo/dice.png"},
  { id: 14, name: "Econonics & Business", event1: "Travelogue" , image: "src/Images/hubs_logo/E&B.png"},
  { id: 15, name: "Game Dev", event1: "The Hollow Escape", event2: "PS Game Fest", image: "src/Images/hubs_logo/gameDev.jpg" },
  { id: 16, name: "Consultancy Club", event1: "Brandscript Ai", image: "src/Images/hubs_logo/ConsultingClub.jpg" },
  { id: 17, name: "Expressions", event1: "Canvas Conclave", event2: "Trivia Tints", image: "src/Images/hubs_logo/expressions.jpeg" },
  { id: 18, name: "KPH ", event1: "Knuth Cup", event2: "Code Ne Bana Di Jodi" , image: "src/Images/hubs_logo/knuth.png"},
  { id: 19, name: "DSC", event1: "Glitchy You or System?", event2: "Decode The Drama" , image: "src/Images/hubs_logo/DSC.png"},
  { id: 20, name: "CICE", event1: "Escape Room", event2: "Electric Tambola" , image: "src/Images/hubs_logo/CICE.png"},
  { id: 21, name: "UCR", event1: "Grip N' Groove", event2: "RoboSoccer", image: "src/Images/hubs_logo/UCR.png" },
  { id: 22, name: "Zencoders", event1: "Build-Chella", event2: "Hack a Match" , image: "src/Images/hubs_logo/Zencoders.png"},

  { id: 23, name: "Yoga, Health and Prahari", event1: "Yoga se hi Hoga", event2: "Tote-ally Zen" , image: "src/Images/hubs_logo/Yoga.png"},
  { id: 24, name: "HRUDAY", event1: "The Pirate's Curse" , image: "src/Images/hubs_logo/HRUDAY.jpeg"},
  { id: 25, name: "AI/ML", event1: "Mind Escape 2.0", event2: "src/Images/hubs_logo/aimi logo.jpg", image: "src/Images/hubs_logo/Aiml.jpg" },
  { id: 26, name: "Ai Tronics", event1: "Digital Escape City", event2: "Think & Blink" , image: "src/Images/hubs_logo/ai_tronics.jpeg"},
  { id: 27, name: "Page Turner Society", event1: "Jimmy Jab Games", event2: "Family Feud" , image: "src/Images/hubs_logo/PTS.png"},
  { id: 28, name: "Marketing Minds", event1: "BrandVerse", image: "src/Images/hubs_logo/MM_Black.png" },
  { id: 29, name: "Umang", event1: "Dimag Ka Dangal" , image: "src/Images/hubs_logo/Umang.png"},
  { id: 30, name: "Parola X Debsoc", event1: "Press Conference", image: "src/Images/hubs_logo/Parola.png" },
];


const galleryImages = [
  "src//Images/Past_Echos/a.webp",
  "src//Images/Past_Echos/b.webp",
  "src//Images/Past_Echos/c.webp",
  "src//Images/Past_Echos/d.webp",
  "src//Images/Past_Echos/eight.webp",
  "src//Images/Past_Echos/five.webp",
  "src//Images/Past_Echos/four.webp",
  "src//Images/Past_Echos/i.webp",
  "src//Images/Past_Echos/seven.webp",
  "src//Images/Past_Echos/m.webp",
  "src//Images/Past_Echos/n.webp",
...
const teamData = [
  { id: 1, name: "Prof.Manish Kumar Thakur", role: "Faculty Advisor ", image: "src/Images/Heads_photos/Manish_sir.jpeg" },
  { id: 2, name: "Dr.Taj Alam", role: "Faculty Coordinator", image: "src/Images/Heads_photos/taj_alam.png" },
  { id: 3, name: "Dr.Neetima Agrawal", role: "Faculty Coordinator", image: "src/Images/Heads_photos/Neetima_mam.jpeg" },
  { id: 4, name: "Ankur kumar Bharadwaj", role: "Faculty Coordinator", image: "src/Images/Heads_photos/Ankur.jpeg" },
  { id: 5, name: "Mr.Ritesh Kumar", role: "Faculty Coordinator", image: "src/Images/Heads_photos/Riteshh.jpeg" },
  { id: 6, name: "Sh.Amit Mishra", role: "Faculty Coordinator", image: "src/Images/Heads_photos/Amit.jpeg" },
  ...
  { id: 10, name: "Aditya Pandey", role: "Internal Affairs Head", image: "public/Aditya.jpg" },
  ...
  { id: 14, name: "Ritish Jaiswal", role: "Digital Head", image: "src/Images/Heads_photos/Ritish_j.jpeg" },
  { id: 15, name: "Deepi Chaudhary", role: "Creative Head", image: "src/Images/Heads_photos/Deepi.jpg" },
  { id: 16, name: "Ramanshi Singhal", role: "Creative Head", image: "src/Images/Heads_photos/ramanshi.jpeg" },
  { id: 17, name: "Yuvraj Chabra", role: "Strategic Head", image: "src/Images/Heads_photos/Yuvraj_Chhabra.jpg" },
  { id: 18, name: "Mayank Varshney", role: "Strategic Head", image: "src/Images/Heads_photos/Mayank.jpg" },
  { id: 19, name: "Vijaya Singh", role: "Content Head", image: "src/Images/Heads_photos/Vijaya.jpeg" },
  { id: 20, name: "Eshita Singh", role: "Content Head", image: "src/Images/Heads_photos/eshita.jpg" },
  { id: 21, name: "Akarsh Jain", role: "PR Head", image: "src/Images/Heads_photos/Akarsh.jpeg" },
  { id: 22, name: "Harshit Yadav", role: "BBA Head", image: "src/Images/Heads_photos/Harshit.jpg" },
  { id: 23, name: "Madhav Agrawal", role: "Hospitality Head", image: "src/Images/Heads_photos/madhav.png" }
];
